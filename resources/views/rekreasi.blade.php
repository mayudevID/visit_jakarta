          ...
          <div class="col">
            <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
              ...
              @foreach ($recreations as $recreation)
                @if ($recreation->location->name == "Jakarta Pusat")
                  <div class="row mb-5">
                    <div class="col-md-7">
                      ...
                      <div class="col">
                        <img class="img-fluid" src="{{ asset('storage/' . $recreation->mainPhoto) }}" width="300px" alt="{{ $recreation->title }}">
                      </div>
                  </div>                
                @endif
              @endforeach
              ...
              @foreach ($recreations as $recreation)
                @if ($recreation->location->name == "Jakarta Barat")
                  <div class="row mb-5">
                  <div class="col-md-7">
                        <h4 class="mt-3">{{ $recreation["title"] }}</h4>
                        <p class="subtitle fw-semibold mt-3">{!! $recreation["description"] !!}</p>
              ...
              @foreach ($recreations as $recreation)
                @if ($recreation->location->name == "Jakarta Selatan")
                  <div class="row mb-5">
                  <div class="col-md-7">
                        <h4 class="mt-3">{{ $recreation["title"] }}</h4>
                        <p class="subtitle fw-semibold mt-3">{!! $recreation["description"] !!}</p>
              ...
              @foreach ($recreations as $recreation)
                @if ($recreation->location->name == "Jakarta Utara")
                  <div class="row mb-5">
                  <div class="col-md-7">
                        <h4 class="mt-3">{{ $recreation["title"] }}</h4>
                        <p class="subtitle fw-semibold mt-3">{!! $recreation["description"] !!}</p>
              ...
              @foreach ($recreations as $recreation)
                @if ($recreation->location->name == "Jakarta Timur")
                  <div class="row mb-5">
                  <div class="col-md-7">
                        <h4 class="mt-3">{{ $recreation["title"] }}</h4>
                        <p class="subtitle fw-semibold mt-3">{!! $recreation["description"] !!}</p>
